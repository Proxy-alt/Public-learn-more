...
( () => {
    ...
    ;
    var p = (a, e, r) => (r = a != null ? Ge($e(a)) : {},
    ze(e || !a || !a.__esModule ? B(r, "default", {
        value: a,
        enumerable: !0
    }) : r, a));
    var d = Qe( (st, x) => {
        "use strict";
        var m = typeof Reflect == "object" ? Reflect : null, K = m && typeof m.apply == "function" ? m.apply : function(e, r, t) {
            return Function.prototype.apply.call(e, r, t)
        }
        , w;
        m && typeof m.ownKeys == "function" ? w = m.ownKeys : Object.getOwnPropertySymbols ? w = function(e) {
        ...
        function z(a, e, r, t) {
            ...
            a._eventsCount = 0) : (i.newListener !== void 0 && (a.emit("newListener", e, r.listener ? r.listener : r),
            i = a._events),
            n = i[e]),
            n === void 0)
                n = i[e] = r,
                ++a._eventsCount;
            else if (typeof n == "function" ? n = i[e] = t ? [r, n] : [n, r] : t ? n.unshift(r) : n.push(r),
            o = Q(a),
        ...
        c.prototype.once = function(e, r) {
            return y(r),
            this.on(e, J(this, e, r)),
            this
        }
        ;
        c.prototype.prependOnceListener = function(e, r) {
            return y(r),
            this.prependListener(e, J(this, e, r)),
            this
        }
        ;
        ...
        c.prototype.removeAllListeners = function(e) {
            ...
            if (t.removeListener === void 0)
                ...
                this._eventsCount = 0) : t[e] !== void 0 && (--this._eventsCount === 0 ? this._events = Object.create(null) : delete t[e]),
                this;
        ...
        function Y(a, e, r) {
            ...
            if (t === void 0)
                return [];
            var o = t[e];
            return o === void 0 ? [] : typeof o == "function" ? r ? [o.listener || o] : [o] : r ? et(o) : ee(o, o.length)
        }
        ...
        c.listenerCount = function(a, e) {
            return typeof a.listenerCount == "function" ? a.listenerCount(e) : Z.call(a, e)
        }
        ;
    ...
    var E = class extends re.default {
        constructor(e) {
            ...
            this.title = e.nativeMethods.getOwnPropertyDescriptor(this.docProto, "title"),
            this.cookie = e.nativeMethods.getOwnPropertyDescriptor(this.docProto, "cookie"),
            this.referrer = e.nativeMethods.getOwnPropertyDescriptor(this.docProto, "referrer"),
            this.domain = e.nativeMethods.getOwnPropertyDescriptor(this.docProto, "domain"),
            this.documentURI = e.nativeMethods.getOwnPropertyDescriptor(this.docProto, "documentURI"),
            ...
            this.URL = e.nativeMethods.getOwnPropertyDescriptor(this.docProto, "URL")
        }
        ...
        overrideDocumentURI() {
            this.ctx.overrideDescriptor(this.docProto, "documentURI", {
                get: (e, r) => {
                    ...
                    return this.emit("documentURI", t),
                    t.intercepted ? t.returnValue : t.data.value
                }
            })
        }
    ...
    var O = class extends oe.default {
        constructor(e) {
            ...
            this.innerHTML = e.nativeMethods.getOwnPropertyDescriptor(this.elemProto, "innerHTML"),
            this.outerHTML = e.nativeMethods.getOwnPropertyDescriptor(this.elemProto, "outerHTML"),
        ...
        overrideAudio() {
            this.ctx.override(this.window, "Audio", (e, r, t) => {
                if (!t.length)
                    return new e(...t);
                let[o] = t
                  , i = new s({
        ...
        overrideHtml() {
            this.hookProperty(this.Element, "innerHTML", {
                get: (e, r) => {
                    ...
                    return this.emit("getInnerHTML", t),
                    t.intercepted ? t.returnValue : t.data.value
                }
                ,
                set: (e, r, [t]) => {
            ...
            this.hookProperty(this.Element, "outerHTML", {
                get: (e, r) => {
                    ...
                    return this.emit("getOuterHTML", t),
                    t.intercepted ? t.returnValue : t.data.value
                }
                ,
                set: (e, r, [t]) => {
        ...
        hookProperty(e, r, t) {
            ...
            if (this.ctx.nativeMethods.isArray(e)) {
                for (let i of e)
                    this.hookProperty(i, r, t);
                return !0
            }
            let o = e.prototype;
            return this.ctx.overrideDescriptor(o, r, t),
            !0
        }
    }
      , ne = O;
    ...
    var M = class extends se.default {
        constructor(e) {
            ...
            this.textContent = e.nativeMethods.getOwnPropertyDescriptor(this.nodeProto, "textContent"),
            this.parentNode = e.nativeMethods.getOwnPropertyDescriptor(this.nodeProto, "parentNode"),
            this.parentElement = e.nativeMethods.getOwnPropertyDescriptor(this.nodeProto, "parentElement"),
            this.childNodes = e.nativeMethods.getOwnPropertyDescriptor(this.nodeProto, "childNodes"),
            this.baseURI = e.nativeMethods.getOwnPropertyDescriptor(this.nodeProto, "baseURI"),
            this.previousSibling = e.nativeMethods.getOwnPropertyDescriptor(this.nodeProto, "previousSibling"),
            this.ownerDocument = e.nativeMethods.getOwnPropertyDescriptor(this.nodeProto, "ownerDocument")
        }
        overrideTextContent() {
            this.ctx.overrideDescriptor(this.nodeProto, "textContent", {
                get: (e, r) => {
                    ...
                    return this.emit("getTextContent", t),
                    t.intercepted ? t.returnValue : t.data.value
                }
                ,
                set: (e, r, [t]) => {
        ...
        overrideParent() {
            ...
            this.ctx.overrideDescriptor(this.nodeProto, "parentElement", {
                get: (e, r) => {
                    ...
                    return this.emit("parentElement", t),
                    t.intercepted ? t.returnValue : t.data.node
                }
            })
        }
        overrideOwnerDocument() {
            this.ctx.overrideDescriptor(this.nodeProto, "ownerDocument", {
                get: (e, r) => {
                    ...
                    return this.emit("ownerDocument", t),
                    t.intercepted ? t.returnValue : t.data.document
                }
            })
        }
        overrideCompareDocumentPosit1ion() {
            this.ctx.override(this.nodeProto, "compareDocumentPosition", (e, r, t) => {
                if (!t.length)
                    return e.apply(r, t);
                let[o] = t
                  , i = new s({
    ...
    var L = class extends le.default {
        constructor(e) {
            ...
            this.value = e.nativeMethods.getOwnPropertyDescriptor(this.attrProto, "value"),
            this.name = e.nativeMethods.getOwnPropertyDescriptor(this.attrProto, "name"),
    ...
    var k = class extends ue.default {
        ...
        overrideFunction() {
            this.ctx.override(this.window, "Function", (e, r, t) => {
                if (!t.length)
                    return e.apply(r, t);
                let o = t[t.length - 1]
                  , i = [];
    ...
    var D = class extends de.default {
        ...
        overrideGetOwnPropertyDescriptors() {
            this.ctx.override(this.Object, "getOwnPropertyDescriptors", (e, r, t) => {
                if (!t.length)
                    return e.apply(r, t);
                let[o] = t
                  , i = new s({
                    descriptors: e.call(r, o)
                },e,r);
    ...
    var N = class extends fe.default {
        constructor(e) {
            ...
            this.reqUrl = e.nativeMethods.getOwnPropertyDescriptor(this.reqProto, "url"),
            this.resUrl = e.nativeMethods.getOwnPropertyDescriptor(this.resProto, "url"),
            this.reqHeaders = e.nativeMethods.getOwnPropertyDescriptor(this.reqProto, "headers"),
            this.resHeaders = e.nativeMethods.getOwnPropertyDescriptor(this.resProto, "headers")
        }
        override() {
        ...
        overrideRequest() {
            return this.fetch ? (this.ctx.override(this.window, "fetch", (e, r, t) => {
            ...
            this.ctx.override(this.window, "Request", (e, r, t) => {
                if (!t.length)
                    return new e(...t);
                let[o,i={}] = t
                  , n = new s({
        ...
        overrideUrl() {
            ...
            this.ctx.overrideDescriptor(this.resProto, "url", {
                get: (e, r) => {
                    ...
                    return this.emit("responseUrl", t),
                    t.intercepted ? t.returnValue : t.data.value
                }
            }),
            !0
        ...
        overrideHeaders() {
            return this.Headers ? (this.ctx.overrideDescriptor(this.reqProto, "headers", {
                get: (e, r) => {
                    ...
                    return this.emit("requestHeaders", t),
                    t.intercepted ? t.returnValue : t.data.value
                }
            }),
            this.ctx.overrideDescriptor(this.resProto, "headers", {
                get: (e, r) => {
                    ...
                    return this.emit("responseHeaders", t),
                    t.intercepted ? t.returnValue : t.data.value
                }
            }),
    ...
    var R = class extends ve.default {
        constructor(e) {
            ...
            this.responseURL = e.nativeMethods.getOwnPropertyDescriptor(this.xhrProto, "responseURL"),
            this.responseText = e.nativeMethods.getOwnPropertyDescriptor(this.xhrProto, "responseText")
        }
        override() {
            this.overrideOpen(),
            this.overrideSend(),
        ...
        overrideOpen() {
            this.ctx.override(this.xhrProto, "open", (e, r, t) => {
                ...
                return this.emit("open", u),
                u.intercepted ? u.returnValue : u.target.call(u.that, u.data.method, u.data.input, u.data.async, u.data.user, u.data.password)
            }
            )
        }
        overrideResponseUrl() {
        ...
        overrideGetResHeaders() {
            this.ctx.override(this.xhrProto, "getAllResponseHeaders", (e, r) => {
                ...
                return this.emit("getAllResponseHeaders", t),
                t.intercepted ? t.returnValue : t.data.value
            }
            )
        }
    ...
    var V = class extends ye.default {
        constructor(e) {
            ...
            this.url = e.nativeMethods.getOwnPropertyDescriptor(this.esProto, "url"),
            this.CONNECTING = 0,
            this.OPEN = 1,
            this.CLOSED = 2
        }
        overrideConstruct() {
            this.ctx.override(this.window, "EventSource", (e, r, t) => {
                if (!t.length)
                    return new e(...t);
                let[o,i={}] = t
                  , n = new s({
    ...
    var xe = p(d(), 1)
      , I = class extends xe.default {
        constructor(e) {
            ...
            this.href = this.WorkerLocation ? e.nativeMethods.getOwnPropertyDescriptor(this.workerLocProto, "href") : e.nativeMethods.getOwnPropertyDescriptor(this.location, "href")
        }
        ...
        emulate(e, r) {
            ...
            for (let i of o.keys)
                this.ctx.nativeMethods.defineProperty(t, i, {
                    ...
                    set: i !== "origin" ? function(n) {
                        switch (i) {
                        case "href":
                            o.location.href = r(n);
                            break;
                        case "hash":
                            o.emit("hashchange", t.href, n.trim().startsWith("#") ? new URL(n.trim(),t.href).href : new URL("#" + n.trim(),t.href).href, o);
                            break;
                        default:
                            {
                                let l = new URL(t.href);
                                l[i] = n,
                                o.location.href = r(l.href)
                            }
                            break
                        }
                    }
            ...
            return "reload"in this.location && this.ctx.nativeMethods.defineProperty(t, "reload", {
                value: this.ctx.wrap(this.location, "reload", (i, n) => i.call(n === t ? this.location : n)),
                writable: !1,
                enumerable: !0
            }),
            "replace"in this.location && this.ctx.nativeMethods.defineProperty(t, "replace", {
                value: this.ctx.wrap(this.location, "assign", (i, n, l) => {
                    (!l.length || n !== t) && i.call(n),
                    n = this.location;
                    let[h] = l
                      , u = new URL(h,t.href);
            ...
            "assign"in this.location && this.ctx.nativeMethods.defineProperty(t, "assign", {
                value: this.ctx.wrap(this.location, "assign", (i, n, l) => {
                    (!l.length || n !== t) && i.call(n),
                    n = this.location;
                    let[h] = l
            ...
            "ancestorOrigins"in this.location && this.ctx.nativeMethods.defineProperty(t, "ancestorOrigins", {
                get() {
                    let i = [];
                    return o.window.DOMStringList && o.ctx.nativeMethods.setPrototypeOf(i, o.window.DOMStringList.prototype),
                    i
                },
                set: void 0,
                enumerable: !0
            ...
            this.ctx.window.Location && this.ctx.nativeMethods.setPrototypeOf(t, this.ctx.window.Location.prototype),
            t
        }
    }
      , Se = I;
    ...
    var T = class extends Ee.default {
        constructor(e) {
            ...
            this.messageData = e.nativeMethods.getOwnPropertyDescriptor(this.messageProto, "data"),
            this.messageOrigin = e.nativeMethods.getOwnPropertyDescriptor(this.messageProto, "origin")
        }
        overridePostMessage() {
        ...
        wrapPostMessage(e, r, t=!1) {
            return this.ctx.wrap(e, r, (o, i, n) => {
                if (this.ctx.worker ? !n.length : 2 > n)
                    return o.apply(i, n);
                let l, h, u;
                t ? ([l,u=[]] = n,
                h = null) : [l,h,u=[]] = n;
                ...
                return this.emit("postMessage", f),
                f.intercepted ? f.returnValue : t ? f.target.call(f.that, f.data.message, f.data.transfer) : f.target.call(f.that, f.data.message, f.data.origin, f.data.transfer)
            }
            )
        }
    ...
    async function A() {
        let e = (await self.clients.matchAll({
          ...
          , r = Promise.race([Promise.any(e), new Promise( (t, o) => setTimeout(o, 1e3, new TypeError("timeout")))]);
        try {
            return await r
        } catch (t) {
    ...
    function De(a, e) {
        ...
        return e && it.addEventListener("message", t => {
    ...
    var U = class {
        ...
        createChannel(e, r) {
            if (self.clients)
                ...
                if (console.debug("bare-mux: got localStorage bare-mux-path:", t),
                !t)
    ...
    var W = class extends Re.default {
        ...
        overrideWorker() {
            this.ctx.override(this.window, "Worker", (e, r, t) => {
                if (!t.length)
                    return new e(...t);
                let[o,i={}] = t
                  , n = new s({
                ...
                this.emit("worker", n);
                let l;
                n.intercepted ? l = n.returnValue : l = new n.target(n.data.url,n.data.options);
                let h = new g;
                return (async () => {
        ...
        emulate(e, r={}) {
            ...
            let t = new this.ctx.window.Proxy(r,{
                ...
                deleteProperty: (o, i) => {
                    ...
                    return this.emit("delete", n),
                    n.intercepted ? n.returnValue : delete e[n.data.name]
                }
            });
            return this.wrappers.set(t, e),
    ...
    var _ = class extends Ae.default {
        constructor(e) {
            ...
            this.cssText - e.nativeMethods.getOwnPropertyDescriptors(this.cssStyleProto, "cssText"),
        ...
        overrideName() {
            this.ctx.overrideDescriptor(this.idbDatabaseProto, "name", {
                get: (e, r) => {
                    ...
                    return this.emit("idbFactoryName", t),
                    t.intercepted ? t.returnValue : t.data.value
                }
            })
        }
    ...
    var G = class extends qe.default {
        constructor(e) {
            ...
            this.url = e.nativeMethods.getOwnPropertyDescriptor(this.wsProto, "url"),
            this.protocol = e.nativeMethods.getOwnPropertyDescriptor(this.wsProto, "protocol"),
            this.readyState = e.nativeMethods.getOwnPropertyDescriptor(this.wsProto, "readyState"),
        ...
        overrideWebSocket() {
            this.ctx.override(this.window, "WebSocket", (e, r, t) => {
                if (!t.length)
                    return new e(...t);
                let o = new s({
                    args: t
    ...
    var b = class extends Fe.default {
        ...
        overrideDescriptor(e, r, t={}) {
            ...
            return o ? (this.nativeMethods.defineProperty(e, r, o),
            o) : {}
        }
        wrap(e, r, t, o=!1) {
            let i = e[r];
            ...
            return o && (n.prototype = i.prototype,
        ...
        wrapDescriptor(e, r, t={}) {
            ...
            if (!o)
                return !1;
            for (let i in t)
                i in o && (i === "get" || i === "set" ? o[i] = this.wrap(o, i, t[i]) : o[i] = typeof t[i] == "function" ? t[i](o[i]) : t[i]);
            return o
        }
    }
      , vr = b;
