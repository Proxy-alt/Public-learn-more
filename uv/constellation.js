        ...
        async fetch({request: t}) {
            ...
            try {
                ...
                let h = await this.bareClient.fetch(i, {
                  ...
                  , s = new y(r,h)
                  , d = new m(s,null,null);
                if (this.emit("beforemod", d),
                d.intercepted)
                    return d.returnValue;
                for (let n of x)
                    s.headers[n] && delete s.headers[n];
...
`,
                ...
                return r.headers.accept === "text/event-stream" && (s.headers["content-type"] = "text/event-stream"),
                crossOriginIsolated && (s.headers["Cross-Origin-Embedder-Policy"] = "require-corp"),
                this.emit("response", d),
                d.intercepted ? d.returnValue : new Response(s.body,{
                    headers: s.headers,
                    status: s.status,
                ...
                O(e, i, this.address)) : new Response(void 0,{
                    status: 500
                })
            }
        }
    ...
    function O(o, t, i) {
        ...
        r = o instanceof Error ? o.name : "UNKNOWN"),
        new Response(U(a, r, l, c, String(o), t, i),{
            status: e,
            headers: {
